...
$sql = "INSERT INTO users (lastname, firstname, username, email, password) VALUES (?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssss", $lastname, $firstname, $username, $email, $hashedPassword);

if ($stmt->execute()) {
    // After successful signup, return to login with username prefilled and signup visible
